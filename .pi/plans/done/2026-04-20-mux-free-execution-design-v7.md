# Mux-Free Execution Implementation Plan (v7)
...
**What's new in v7 (vs. v6):** the two remaining findings from `.pi/plans/reviews/2026-04-20-mux-free-execution-design-review-v8.md` are remediated — see the "v7 changelog" section at the bottom of this document for the full list. In summary:
...
- [ ] **Step 5: Add the pane-Claude E2E restriction integration test (v6 — review-v7 additional note 2; v7 — review-v8 finding 2)**
...
Expected: PASS on both cases if Claude is on PATH; skipped otherwise. A regression of review-v7 finding 1 manifests as case 1 failing because Bash actually ran. A regression of review-v8 finding 2 manifests as case 2 hanging up to the test timeout (because `--print` becomes a positional, non-interactive mode is not engaged, and Claude sits in interactive mode waiting for more input).
