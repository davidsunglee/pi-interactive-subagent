# Mux-Free Execution Implementation Plan (v15)
...
This must land before Step 4b because Step 4b imports `makeHeadlessBackend` from this file. The stub is also the module Task 8 Step 3 rewires `default-deps.ts` around.
